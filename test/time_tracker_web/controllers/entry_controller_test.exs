defmodule TimeTrackerWeb.EntryControllerTest do
  use TimeTrackerWeb.ConnCase

  alias TimeTracker.Entries

  @create_attrs %{description: "some description", end_time: "2010-04-17T14:00:00Z", start_time: "2010-04-17T14:00:00Z"}
